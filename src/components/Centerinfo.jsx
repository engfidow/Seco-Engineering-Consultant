...
const Centerinfo = () => {
  return (
    <div className="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1  mt-10" >
      <div className="bg-[#F3F8FF]  py-5 px-12  flex justify-evenly items-center flex-col drop-shadow-sm border-r-2 border-r-dashed  border-gray-300">
      ...
      <div className="bg-[#F3F8FF]  py-5 px-12  flex justify-evenly items-center flex-col drop-shadow-sm border-gray-300">
